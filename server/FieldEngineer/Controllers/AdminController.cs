...
namespace FieldEngineer.Controllers
{
    public class AdminController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "Id,AgentId,JobNumber,Title,Date,StartTime,EndTime,Status,CustomerName,CustomerAddress,CustomerPhoneNumber,WorkPerformed,Version,CreatedAt,UpdatedAt,Deleted")] Job job)
        {
